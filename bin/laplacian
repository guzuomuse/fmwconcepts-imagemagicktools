#!/bin/bash
# 
# Developed by Fred Weinhaus 9/20/2007 .......... revised 3/5/2010
# 
...
# process image
convert $infile -convolve "$kernIM" $threshoption $tmp0
[ $mix -lt 100 ] && composite -blend $mix $tmp0 $infile -matte $tmp0

#!/bin/bash
#
# Developed by Fred Weinhaus 10/13/2008 .......... revised 6/3/2009
#
...
# adjustment using -recolor. Method 2 uses an additive adjustment 
# using -evaluate add. Both methods compute RGB channel averages of a 
# user specified percentage of pixels closest to white. The channel 
...
# where the recolor matrix values are the ratios of 100% to the channel 
# averages in percent graylevel. Method 2 uses an additive adjustment 
